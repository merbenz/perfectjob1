...
<div class="page-heading">
		<h1>บริการสำหรับบริษัท-Profile</h1>
		<ol class="breadcrumb">
            
			<li>Home</li>
			<li><a href="/manage/center">Backend</a></li>
			<li class="active">จัดการข้อมูล | บริการสำหรับบริษัท-Profile</li>
		</ol>
	</div>
	<div class="page-body">
			...
			<div class="panel-body">
				<div class="form-group m-b-0">
					<div style="float:right;">
                        <a href="/create/services-profile">
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#footer-select').DataTable({
            ...
            lengthChange: true,
            ajax: {
                url: "{{url('services-profile/datatables')}}",
            },
            columns: [ 
                   { data: 'id'}, 
                   { data: 'title_th'}, 
            ...
            rowCallback: function (row, data, index) {
                    //  console.log(data);
                    i++;
                    var button =  '<center><a href="../view/services-profile/'+data.id+'">'+
      ...
      //  alert(id)
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'get',
                    url: "{{ url('/delete/services-profile')}}",
                    data: {
                        'id': id
                    },
