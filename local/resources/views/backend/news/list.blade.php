...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">จัดการข้อมูล | ข่าวสาร</li>
    </ol>
</div>
<div class="page-body">
        ...
        <div class="panel-body">
            <div class="form-group m-b-0">
                <div style="float:right;">
                    <a href="/create/news">
                        <button class="btn btn-primary btn-mini btn-round waves-effect waves-light mt-1"><i
                                class="fa fa-plus-circle"></i>&nbsp;เพิ่มข้อมูล</button>
                    </a>
                </div>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#footer-select').DataTable({
            ...
            rowCallback: function (row, data, index) {
                    //  console.log(data);
                    i++;
                    var button =  '<center><a href="../view/news/'+data.id+'">'+
