...
<form action="{{ (empty($company_info) ? url('manage/companyinfomation') : url('update/companyinfomation').'/'.$company_info->idCompany ) }}" method="POST" enctype="multipart/form-data" >
<!-- Alignments -->
		...
		<div class="panel panel-default">
			...
			{{ csrf_field() }}
				<div class="form-group">
					...
					<input type="file" name="banner" class="form-control" value="{{ isset($company_info)?$company_info->banner:'' }}"><br>
					@if(!empty($company_info->banner))
						<div class="breadcrumb breadcrumb-bg-success" style="text-align: center;">
							<img src="{{ asset('images/company/banner/').'/'.$company_info->banner }}" style="height:100px;"/>
						</div> 	 
					@endif
				</div>
			</div>
...
<div class="page-body">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Upload โลโก้บริษัท</div>
			<div class="panel-body">
			{{ csrf_field() }}
				<div class="form-group">
					<label>Upload โลโก้บริษัท : </label>
					<input type="file" name="chooseFile1" class="form-control" value="{{ isset($company_info)?$company_info->chooseFile1:'' }}"><br>
					@if(!empty($company_info->chooseFile1))
						<div class="breadcrumb breadcrumb-bg-success" style="text-align: center;">
							<img src="{{ asset('images/company/').'/'.$company_info->chooseFile1 }}" style="height:100px;"/>
						</div> 	 
					@endif
				</div>
			</div>
...
<div class="page-body">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Upload รูปบริษัท</div>
			<div class="panel-body">
			{{ csrf_field() }}
				<div class="form-group">
					<label>Upload รูปบริษัท : </label>
					<input type="file" name="chooseFile2" class="form-control" value="{{ isset($company_info)?$company_info->chooseFile2:'' }}"><br>
					@if(!empty($company_info->chooseFile2))
						<div class="breadcrumb breadcrumb-bg-success" style="text-align: center;">
							<img src="{{ asset('images/company/').'/'.$company_info->chooseFile2 }}" style="height:100px;"/>
						</div> 	 
					@endif
				</div>
			</div>
