...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#footer-select').DataTable({
            ...
            lengthChange: true,
            ajax: {
                url: "{{url('requestquote/datatables')}}",
            },
            columns: [ 
                   { data: 'idQuote'}, 
                   { data: 'namecompany'}, 
            ...
            rowCallback: function (row, data, index) {
                    //  console.log(data);
                    i++;
                    var button =  '<center><a href="../view/requestquote/'+data.idQuote+'">'+
                                    '<button type="submit" class="btn btn-circle btn-default">'+
                                    '<i class="fa fa-edit"></i>'+
                                    '</button>'+
                                    '</a>'

                    button +=  '<a onclick="chk('+data.idQuote+')">'+
