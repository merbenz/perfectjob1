...
<div class="page-heading">
		<h1>เกี่ยวกับเรา-Mission</h1>
		<ol class="breadcrumb">
            
			<li>Home</li>
			<li><a href="/manage/center">Backend</a></li>
			<li class="active">จัดการข้อมูล | เกี่ยวกับเรา-Mission</li>
		</ol>
	</div>
	<div class="page-body">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#footer-select').DataTable({
            ...
            rowCallback: function (row, data, index) {
                    //  console.log(data);
                    i++;
                    var button =  '<center><a href="../view/mission/'+data.id+'">'+
