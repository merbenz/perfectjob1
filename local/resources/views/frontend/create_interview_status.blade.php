...
@include('frontend.inc_menu')
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-9 pad_create_profile">
                    <div class="create_profile green">
                        <h4>สถานะการสัมภาษณ์</h4>
                        <div class="row bg_have_applied">
                            <div class="col-12 col-md-6">
                                <div class="have_applied">คุณสัมภาษณ์ไปแล้ว <span>2</span> ตำแหน่ง</div>
                            </div>
                                ...
                                <table class="table">
                                    <thead class="thead_table_steps">
                                        <tr>
                                            <th>ลำดับ</th>
                                            <th>รายละเอียด</th>
                                            <th style="text-align: center;">V.D.O Clip<br>Upload</th>
                                            <th style="text-align: center;">Selected<br>ได้รับเลือกสัมภาษณ์</th>
                                            <th style="text-align: center;">Via Zoom<br>สัมภาษณ์ผ่าน Zoom</th>
                                            <th style="text-align: center;">at customer office<br>สัมภาษณ์ที่บริษัท</th>
                                            <th style="text-align: center;">Apprroved<br>อนุมัติ</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <script>
        $('.sidemenumem li:nth-child(14) ').addClass('active');
    </script>
