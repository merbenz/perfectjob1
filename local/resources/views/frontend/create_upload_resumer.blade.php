        ...
        <div class="container nopad_mobile">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-9 pad_create_profile">
                    <div class="create_profile blue">
                        <h4>อัพโหลดเรซูเม่</h4>
                        <div class="upload_picture">
                            ...
                            <h6>
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="option1" >เพิ่มเรซูเม่
                               </label>
                            </h6>
                        </div>
