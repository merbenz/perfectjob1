                   ...
                   <div class="col-12">
                       <div class="service_package">
                        ...
                        @include('frontend.inc_services')
                           ...
                           <div class="button_services"><a href="services.php">ลงทะเบียนทดลองฟรี <i class="fa fa-caret-right" aria-hidden="true"></i></a></div>
                       </div>
                    </div>
                </div>
            </div>
